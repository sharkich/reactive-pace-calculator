...
export function SingleTrainingComponent(props: {
    ...
    <F.div className="training card">
      {props.training.view((training: Training | null) => {
        ...
        return (
          <F.div
            {...classes(
            props.activeTraining.view((activeTraining: Training) => activeTraining && 'training--active')
            )}
          >
